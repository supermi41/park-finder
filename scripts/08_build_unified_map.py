...
map.on('load', async () => {
  ...
  // DEBUG layer: render every parcel solid red, no filter — confirms PMTiles source
  map.addLayer({ id:'parcels-debug', source:'parcels', 'source-layer':'parcels', type:'fill',
    paint:{ 'fill-color':'#ff00ff', 'fill-opacity':0.6 } });
  console.log('parcels-debug layer added');
  ...
  console.log('parcels-fill layer added, filter:', JSON.stringify(combinedParcelFilter()).slice(0,200));
