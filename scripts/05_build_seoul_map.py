...
def main():
    ...
    parks_raw = json.loads((SEOUL / "seoul_parks.geojson").read_text())["features"]
    parcels_raw = json.loads((SEOUL / "seoul_park_parcels_all.geojson").read_text())["features"]
    districts_raw = json.loads((SEOUL / "seoul_districts.geojson").read_text())["features"]
